...
I love doing statistics and data analyses, and aim to develop a career in the field of data science. 

At present, I have solid **knowledge in statistics** including causal inference and regression, time-series analysis, high-dimensional data analysis, etc. Besides, I got plenty of **training in programming**, especially in R, in which I learned to perform data wrangling, pipelining, visualizations, modeling, and produce analysis reports, etc. I also have **experience in machine learning**. In a year-long project, I built and trained an artificial neural network using Python successfully to solve a scientific problem. 
...
You can view my selected projects and homeworks in data analyses [here](projects.html) or click the <font size="3" color="black">'Project'</font> buttom on the site navigation bar.
...
You can view some data visualization examples in R by clicking the <font size="3" color="black">'Data Visualization'</font> buttom on the site navigation bar. You will see a drop-down menu contains 'Plotly Example Code' and 'Dashboard Example'. 
